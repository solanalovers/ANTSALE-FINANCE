        ...
        <div>
            ...
            <div>
                ...
                <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        <Input
                            ...
                            value={
                                form?.presaleRate
                                    ? Number(form?.presaleRate).toLocaleString()
                                    : ""
                            }
                            onBlur={() => {
                                if (form?.presaleRate) {
                        ...
                        {form?.listingOption === "Auto Listing" && (
                            <>
                                <Input
                                    ...
                                    value={
                                        form?.listingRate
                                            ? Number(form?.listingRate).toLocaleString()
                                            : ""
                                    }
                                    onBlur={() => {
                                        if (form?.listingRate) {
                    ...
                    <div>
                        <Input
                            ...
                            placeholder="0"
                            value={
                                form?.softCap ? Number(form?.softCap).toLocaleString() : ""
                            }
                            onBlur={() => {
                                if (form?.softCap) {
                                    handleChangeForm({
                    ...
                    <Input
                        ...
                        onFocus={() => {
                            if (form?.hardCap) {
                                handleChangeForm({
                                    hardCap: parseFloat(
                                        form?.hardCap.toString().replace(/,/g, "")
                                    ),
                                });
                            }
                        }}
                    ...
                    <Input
                        ...
                        onFocus={() => {
                            if (form?.minBuy) {
                                handleChangeForm({
                                    minBuy: parseFloat(
                                        form?.minBuy?.toString().replace(/,/g, "")
                                    ),
                                });
                            }
                        }}
                ...
                <div className="rounded-lg overflow-hidden mt-6">
                    <ToastItem
                        status="info"
                        content={`Need <span class='font-bold'>${calculateListing()}</span> to create launchpad`}
                    />
                </div>
            </div>
        </div>
