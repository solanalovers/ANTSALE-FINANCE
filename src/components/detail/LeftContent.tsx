        ...
        <div>
          ...
          <div className='flex justify-between'>
            ...
            <div className='flex items-center gap-x-3'>
              <Link href={''} isExternal className='hover:opacity-80'>
                <img
              ...
              <Chip color='primary' className='bg-primary-50 text-primary'>
                <div className='flex items-center gap-x-1'>
                  <CheckIcon fill='#006FEE' size='16' />
                  Filled
                </div>
              </Chip>
            </div>
          ...
          <div className='ml-10 mt-4 mb-6'>
            <p className='text-lg font-semibold leading-[22px]'>SMB GEN2</p>
