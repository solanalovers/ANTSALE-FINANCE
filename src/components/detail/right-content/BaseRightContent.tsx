...
export default function BaseRightContent({
    ...
    const setDataClaimable = async () => {
        const {totalContributor, purchased, isClaimable} = await fetchClaimable(data.id, cluster === 1, wallet)
                ...
                <BorderContent>
                    <>
                        ...
                        <div className="flex items-center justify-between mb-3">
                            <p className="text-base font-medium">Total Contributor</p>
                            <p className="text-base leading-6 text-[#1C1C1E]">{totalContributors}</p>
                        </div>
                        <Button
                            color="primary"
                            className="mt-4 w-full"
                        ...
                        >
                            {disableClaim ? purchased ? 'Claimed' : 'Not eligible' : 'Claim your token'}
                        </Button>
                    </>
